/***************************************************************************//**
 * @file win32_BasicNativeHeaders.hpp
...
/** @brief Uses compiler feature detection macros to scan for and include
 * required system headers and libraries. */
#define _WIN32_BASICNATIVEHEADERS_HPP_
